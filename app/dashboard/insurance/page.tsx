                  ...
                  {activeTab === "General" && (
                    <>
                      ...
                      <div className="space-y-1">
                        <label htmlFor="ins-180" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Plan Name</label>
                        <input id="ins-180" disabled={!isEditing} type="text" {...register("plan_name")}
                      ...
                      <div className="space-y-1">
                        <label htmlFor="ins-186" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Plan Code</label>
                        <input id="ins-186" disabled={!isEditing} type="text" {...register("plan_code")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>

                      <div className="space-y-1">
                        <label htmlFor="ins-192" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Carrier ID</label>
                        <input id="ins-192" disabled={!isEditing} type="text" {...register("carrier_id")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                        <FieldError error={errors.carrier_id?.message} />
                      </div>
                      <div className="space-y-1">
                        <label htmlFor="ins-198" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Group #</label>
                        <input id="ins-198" disabled={!isEditing} type="text" {...register("group_number")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>

                      <div className="space-y-1">
                        <label htmlFor="ins-204" className="text-xs text-gray-400 font-medium uppercase tracking-wider">BIN</label>
                        <input id="ins-204" disabled={!isEditing} type="text" {...register("bin")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>
                      <div className="space-y-1">
                        <label htmlFor="ins-209" className="text-xs text-gray-400 font-medium uppercase tracking-wider">PCN</label>
                        <input id="ins-209" disabled={!isEditing} type="text" {...register("pcn")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>
                      ...
                      <div className="space-y-1">
                        <label htmlFor="ins-217" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Help Desk Phone</label>
                        <input id="ins-217" disabled={!isEditing} type="text" {...register("help_desk_phone")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>
                      <div className="space-y-1">
                        <label htmlFor="ins-222" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Fax Number</label>
                        <input id="ins-222" disabled={!isEditing} type="text" {...register("fax_number")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>

                      <div className="space-y-1">
                        <label htmlFor="ins-addr1" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Address Line 1</label>
                        <input id="ins-addr1" disabled={!isEditing} type="text" {...register("address_line1")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>
                      <div className="space-y-1">
                        <label htmlFor="ins-city" className="text-xs text-gray-400 font-medium uppercase tracking-wider">City, State, Zip</label>
                        <div className="flex gap-2">
                          <input id="ins-city" disabled={!isEditing} type="text" placeholder="City" {...register("city")}
                      ...
                      <div className="space-y-1">
                        <label htmlFor="ins-247" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Standard Copay</label>
                        <input id="ins-247" disabled={!isEditing} type="number" step="0.01" {...register("standard_copay")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>
                      <div className="space-y-1">
                        <label htmlFor="ins-252" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Co-Insurance %</label>
                        <input id="ins-252" disabled={!isEditing} type="number" step="0.1" {...register("co_insurance_pct")}
                          className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all disabled:opacity-50" />
                      </div>

                      <div className="col-span-2 space-y-1 mt-2">
                        <label htmlFor="ins-258" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Notes</label>
                        <textarea id="ins-258" disabled={!isEditing} rows={3} {...register("notes")}
