            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-8 max-w-2xl">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-1">
                  <label htmlFor="sig-133" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Sig Code (Abbreviation)</label>
                  <input id="sig-133" type="text" {...register("code", { onChange: (e) => setValue("code", e.target.value.toUpperCase()) })}
                    placeholder="e.g. BID"
                ...
                <div className="space-y-1">
                  <label htmlFor="sig-141" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Language</label>
                  <select id="sig-141" {...register("language")}
                ...
                <div className="col-span-2 space-y-1">
                  <label htmlFor="sig-150" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Full Instruction Text</label>
                  <textarea id="sig-150" rows={3} {...register("full_text")} placeholder="e.g. Take one tablet by mouth twice daily"
                ...
                <div className="space-y-1">
                  <label htmlFor="sig-157" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Days Accumulated (D.A.) Multiplier</label>
                  <input id="sig-157" type="number" step="0.01" {...register("days_accumulated")}
                ...
                <div className="space-y-1">
                  <label htmlFor="sig-163" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Days Supply Offset</label>
                  <input id="sig-163" type="number" {...register("offset", { valueAsNumber: true })}
                    className="w-full bg-black/40 border border-white/10 rounded-md p-2.5 text-sm focus:border-teal-500 outline-none font-mono" />
                </div>
              </div>
            </form>
