            ...
            {!selectedId && !isEditing ? (
              ...
              <>
                ...
                <div className="bg-white/5 rounded-xl border border-white/10 p-4">
                  <label htmlFor="pc-162" className="text-xs text-gray-400 font-medium uppercase tracking-wider">Acquisition Cost (for preview)</label>
                  <input id="pc-162" type="number" step="0.01" value={acqCost || ""} onChange={e => setAcqCost(parseFloat(e.target.value) || 0)}
